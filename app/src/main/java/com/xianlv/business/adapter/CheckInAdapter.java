...
public class CheckInAdapter extends BaseQuickAdapter<CheckInItem, BaseViewHolder> implements LoadMoreModule {
    ...
    @Override
    protected void convert(BaseViewHolder helper,  CheckInItem item) {
