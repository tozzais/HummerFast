...
public class CommonPopupWindow extends ExpandAndCollapseAnimPopupWindow {
    ...
    public static class Builder {
        ...
        public Builder handleHeight(boolean flag){
            params.isHandleHeight=flag;
            return this;
        }

        public CommonPopupWindow build() {
            final CommonPopupWindow popupWindow = new CommonPopupWindow(params.mContext);
            popupWindow.setHandlerHeight(params.isHandleHeight);
