...
import com.xianlv.business.order.fragment.ReserveOrderFragment;
...
public class ReserveOrderActivity extends BaseActivity {
    ...
    public static void launch(Context activity) {
        ...
        Intent intent = new Intent(activity, ReserveOrderActivity.class);
...
//    }
    ...
    public void loadData() {
        ...
        fragmentList.add(ReserveOrderFragment.newInstance(1));
        fragmentList.add(ReserveOrderFragment.newInstance(0));
