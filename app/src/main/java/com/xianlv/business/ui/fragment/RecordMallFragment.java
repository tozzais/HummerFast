...
import com.xianlv.business.adapter.RecordMallAdapter;
...
public class RecordMallFragment extends BaseListFragment<WriteOffHistoryItem> {




    public static RecordMallFragment newInstance(int type){
        RecordMallFragment cartFragment = new RecordMallFragment();
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        mAdapter = new RecordMallAdapter();
